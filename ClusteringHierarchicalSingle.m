function ClusteringHierarchicalSingle(DataSetStartIndex, DataSetEndIndex, DistanceIndex)  
    Distances = [cellstr('ED'), 'NCCc', 'cDTW5'];
    
    % Datasets into consideration
    Datasets1 = [cellstr('ChlorineConcentration'),'Adiac'...
        'Beef','BeetleFly'...
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex && i<=DataSetEndIndex)
                    ...
                    labels = HierarchicalClustering_Single(DM, length(DS.ClassNames));
            ...
            dlmwrite( strcat( 'RESULTS_ClusteringHierarchicalSingle', '_', char(Distances(DistanceIndex)), '_', num2str(DataSetStartIndex), '_', num2str(DataSetEndIndex) ,'.results'), rand_idxs, 'delimiter', '\t');
